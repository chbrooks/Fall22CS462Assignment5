...
#### Due December 16, 11:59pm. (note: I will not be able to give any extensions to this, as I need time to get final grades submitted.)

Please provide a submission.py that demonstrates your code!

<b>(30 points) Task 1: Q-learning for Blackjack.</b>

[This tutorial](https://gymnasium.farama.org/tutorials/blackjack_tutorial/) shows how to use the Gymnasium environment to train a reinforcement learning agent 
to play Blackjack.

Follow through it and implement your own BlackJack.py agent that learns a policy for playing blackjack. 
In addition, please write a wrapper that allows a human to play against your trained agent, keeping track of wins and losses.

<b>Task 2: Perceptrons. (30 points) </b>
...
<b>Task 3: TensorFlow.(40 points)</b>
